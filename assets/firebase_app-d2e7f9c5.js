 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rt(t){return Q(void 0,t)}function Q(t,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const n=e;return new Date(n.getTime());case Object:t===void 0&&(t={});break;case Array:t=[];break;default:return e}for(const n in e)!e.hasOwnProperty(n)||!ue(n)||(t[n]=Q(t[n],e[n]));return t}function ue(t){return t!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ee(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Lt(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(ee())}function Ht(){var t;const e=(t=D())===null||t===void 0?void 0:t.forceEnvironment;if(e==="node")return!0;if(e==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function jt(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function Ft(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function zt(){const t=ee();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function Vt(){return Y.NODE_ADMIN===!0}function ye(){try{return typeof indexedDB=="object"}catch{return!1}}function Ie(){return new Promise((t,e)=>{try{let n=!0;const s="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(s);r.onsuccess=()=>{r.result.close(),n||self.indexedDB.deleteDatabase(s),t(!0)},r.onupgradeneeded=()=>{n=!1},r.onerror=()=>{var i;e(((i=r.error)===null||i===void 0?void 0:i.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const we="FirebaseError";class E extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=we,Object.setPrototypeOf(this,E.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,te.prototype.create)}}class te{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},r=`${this.service}/${e}`,i=this.errors[e],o=i?ve(i,s):"Error",a=`${this.serviceName}: ${o} (${r}).`;return new E(r,a,s)}}function ve(t,e){return t.replace(De,(n,s)=>{const r=e[s];return r!=null?String(r):`<${s}?>`})}const De=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ne=function(t){let e={},n={},s={},r="";try{const i=t.split(".");e=j(T(i[0])||""),n=j(T(i[1])||""),r=i[2],s=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:s,signature:r}},Wt=function(t){const e=ne(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},Gt=function(t){const e=ne(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const on=Et;function Dt(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:P,automaticDataCollectionEnabled:!1},e),r=s.name;if(typeof r!="string"||!r)throw m.create("bad-app-name",{appName:String(r)});if(n||(n=Z()),!n)throw m.create("no-options");const i=v.get(r);if(i){if(x(n,i.options)&&x(s,i.config))return i;throw m.create("duplicate-app",{appName:r})}const o=new Ne(r);for(const c of k.values())o.addComponent(c);const a=new vt(n,s,o);return v.set(r,a),a}function an(t=P){const e=v.get(t);if(!e&&t===P&&Z())return Dt();if(!e)throw m.create("no-app",{appName:t});return e}function B(t,e,n){var s;let r=(s=yt[t])!==null&&s!==void 0?s:t;n&&(r+=`-${n}`);const i=r.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${r}" with version "${e}":`];i&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),g.warn(a.join(" "));return}L(new w(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mt(t){L(new w("platform-logger",e=>new Je(e),"PRIVATE")),L(new w("heartbeat",e=>new Nt(e),"PRIVATE")),B($,W,t),B($,W,"esm2017"),B("fire-js","")}Mt("");export{Kt as A,Xt as B,w as C,he as D,te as E,E as F,en as G,Vt as H,Ee as I,Gt as J,Wt as K,l as L,nn as M,Rt as N,de as O,Ht as P,Dt as Q,on as S,L as _,Ft as a,sn as b,_e as c,an as d,jt as e,rn as f,Pt as g,Zt as h,Lt as i,x as j,ee as k,$e as l,zt as m,T as n,Yt as o,ce as p,qt as q,B as r,$t as s,kt as t,Ut as u,j as v,Jt as w,tn as x,Qt as y,q as z};
